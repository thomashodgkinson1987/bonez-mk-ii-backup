...
public class LevelPauseMenu : CanvasLayer
{
	...
	public Button node_returnToOverworldButton { get; private set; }
	public Button node_quitToTitleButton { get; private set; }
	...
	[Signal] public delegate void OnReturnToOverworldButtonPressedSignal ();
	...
	public override void _Ready ()
	{
		...
		node_returnToOverworldButton = GetNode<Button>("BackgroundPanel/MenuPanel/ButtonsVBoxContainer/ReturnToOverworldButton");
		node_quitToTitleButton = GetNode<Button>("BackgroundPanel/MenuPanel/ButtonsVBoxContainer/ReturnToTitleButton");
	...
	private void OnReturnToOverworldButtonPressed ()
	{
		EmitSignal(nameof(OnReturnToOverworldButtonPressedSignal));
	}
