...
public class HoppingSlimeState_Walk_Fast : HoppingSlimeState_Timed
{
	...
	public override string StateName => "walk_fast";

	public float WalkSpeed { get; set; } = 32f;
	...
	public HoppingSlimeState_Walk_Fast (Actor actor, HoppingSlime hoppingSlime) : base(actor, hoppingSlime)
	{
	...
	public override void OnEnter ()
	{
		...
		WalkSpeed = m_hoppingSlime.FastWalkSpeed;
